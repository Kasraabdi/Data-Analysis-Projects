...
data = {
    ...
    'Quantity': [6, 6, 8, 32, 6, 6, 3, 6, 24, -6],
    ...
    'UnitPrice': [2.55, 3.39, 2.75, 1.69, 2.1, 4.25, 18.0, 0, 3.75, 4.25],
    'CustomerID': [17850, 17850, 17850, 13047, 13047, '13047', np.nan, 13047, 12583, 12583],
    'Country': ['United Kingdom', 'United Kingdom', 'UK', 'United Kingdom', 'France', 'France', 'France', 'United Kingdom', 'UK', 'France']
}
